...
final class AppStore: ObservableObject {
    ...
    func openPrivacy() {
        ...
        NSWorkspace.shared.open(base.appending(path: "privacy"))
    }

    func openTerms() {
        guard let base = normalizedBaseURL() else { return }
        NSWorkspace.shared.open(base.appending(path: "terms"))
    }
    ...
    func openSwitchAccount() {
        guard let base = normalizedBaseURL() else { return }
        NSWorkspace.shared.open(base.appending(path: "accounts/google/login/"))
    }
